  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative font-sans">
      ...
      <motion.div
        ...
        // Combined the wrapper and the inner div classes here!
        className="relative z-10 w-full max-w-[440px] mx-4 rounded-[2rem] bg-[#0f172a]/40 backdrop-blur-xl border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] p-10 pt-16 pb-12"
      >
        {/* Top Tab for "Login" */}
